...
// Modified for CommonPlace. Modifications marked by ** CFM ** or ** GFM **
...
//
  ...
  // ** GFM **  Auto-link URLs and emails ** CFM **
...
var writeAnchorTag = function(wholeMatch,m1,m2,m3,m4,m5,m6,m7) {
  ...
  /* CFM - protects against XSS via the url */  
...
var _DoItalicsAndBold = function(text) {
	...
	text = text.replace(/(\*\*|__)(?=\S)([^\r]*?\S[*_]*)\1/g,
        ...
        // steal from GFM, don't trigger styling on underscores in middle of words
	...
	for (var i=0; i<end; i++) {
		...
		if (str.search(/~K(\d+)K/g) >= 0) {
			...
			str = _RunSpanGamut(str);
                        str = str.replace(/\n/g,"<br />"); // ** CFM ** stolen from Github Flavored Markdown
			str = str.replace(/^([ \t]*)/g,"<p>");
			str += "</p>"
			grafsOut.push(str);
		}
